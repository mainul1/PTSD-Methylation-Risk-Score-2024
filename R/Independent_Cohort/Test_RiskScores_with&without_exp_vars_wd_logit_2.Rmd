...
emrs <- "../Data/Covariate adjusted and scaled data.xlsx" # Output of "Covariate_Adj_RiskScores_1.R"  

mors_and_morsae <- "../Data/Covariate adjusted and scaled data wo exp vars.xlsx" # output of  Covariate_Adj_RiskScores_without_exp_vars_1.R
...
# eMRS 
emrs_df <- read_allsheets(path = emrs)

# MoRS and MoRSAE
mors_and_morsae_dfs <- read_allsheets(path = mors_and_morsae)


# combine all three dfs together
adj_df <- c(list("With Exposure Variables" = emrs_df$`Without NonCpGXY Probes`),
            mors_and_morsae_dfs)
...
p2_emrs <- make_boxplot(df = adj_df$`With Exposure Variables`, 
                        ...
                        y_pos = 3.5, #location to show significance, please change if needed
                        title = "")
