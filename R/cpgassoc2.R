cpg.assoc2 <- function (beta.val, indep, covariates = NULL, data = NULL, logit.transform = FALSE,
  ...
  if (!large.data) {
    ...
    if (.Platform$OS.type == "windows") {
      maxmemo <- 50000/15 #memory.limit is replaced with the actual amount of memory
    }
    else {
